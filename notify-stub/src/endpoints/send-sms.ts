...
import { successfulJsonResult, errorResult } from "../helpers/results.js";
import { createNotification } from "../services/notifications.js";
import { getNotifyBaseUrl, getFromNumber } from "../configuration.js";
...
async function post(
  ...
  const response: SmsNotificationResponse = {
    ...
    uri: `${baseUrl}/v2/notifications/${record.notification_id}`,
    template: {
