...
export class AccessTokenBuilder {
  private sub = TEST_CONSTANTS.SUBJECT;
  private scope = [amcScopes.ACCOUNT_DELETE];
  private iss = TEST_CONSTANTS.ISSUER;
  private aud = TEST_CONSTANTS.AUDIENCE;
  private clientId = TEST_CONSTANTS.CLIENT_ID;
  private jti = TEST_CONSTANTS.ACCESS_TOKEN_JTI;
  private sid = TEST_CONSTANTS.SESSION_ID;
...
export class CompositeJWTBuilder {
  ...
  private sub = TEST_CONSTANTS.SUBJECT;
  private email = TEST_CONSTANTS.EMAIL;
  private readonly journeyId = TEST_CONSTANTS.JOURNEY_ID;
  private publicSub = TEST_CONSTANTS.PUBLIC_SUBJECT;
  ...
  withPublicSubject(publicSub: string) {
